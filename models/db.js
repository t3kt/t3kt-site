...
(function() {
  var Deferred, MongoClient, NOT_IMPLEMENTED, asyncCall, asyncFindOne, asyncFindToArray, config, connect, getItem, getItems, getProject, getProjects, mongoDb, util, _,
    __slice = [].slice;
  ...
  asyncFindOne = function(collection, args) {
